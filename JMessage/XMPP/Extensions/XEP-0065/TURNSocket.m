...
@synthesize streamhosts = _streamhosts;
...
- (void)sendRequest
{
    ...
    //ADD.MY
//    NSString* myhost = xmppStream.localHost;
//    if (myhost.length > 0) {
...
//        [mystreamhost addAttributeWithName:@"port" stringValue:xmppStream.localPort];
//        [query addChild:mystreamhost];
//    }
